...
use App\Application\Internit\StatusSolicitacaoBundle\Form\StatusSolicitacaoType;
...
#[Route('/web/statusSolicitacao', name: 'web_statusSolicitacao_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'StatusSolicitacao', description: 'Permissões do modulo StatusSolicitacao')]
class StatusSolicitacaoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_statusSolicitacao_';
    }
    ...
    {
        return "@ApplicationInternitStatusSolicitacao/statussolicitacao/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista StatusSolicitacao')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar StatusSolicitacao',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria StatusSolicitacao')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new StatusSolicitacao();
        $form = $this->createForm(StatusSolicitacaoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar StatusSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza StatusSolicitacao')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar StatusSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita StatusSolicitacao')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar StatusSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta StatusSolicitacao')]
