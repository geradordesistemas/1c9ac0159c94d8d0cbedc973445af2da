<?php
namespace App\Application\Internit\StatusSolicitacaoBundle\Admin;
...
final class StatusSolicitacaoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof StatusSolicitacao ? $object->getId().''
