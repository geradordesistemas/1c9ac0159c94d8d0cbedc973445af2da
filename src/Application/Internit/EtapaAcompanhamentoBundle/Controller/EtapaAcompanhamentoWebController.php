...
use App\Application\Internit\EtapaAcompanhamentoBundle\Form\EtapaAcompanhamentoType;
...
#[Route('/web/etapaAcompanhamento', name: 'web_etapaAcompanhamento_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'EtapaAcompanhamento', description: 'Permissões do modulo EtapaAcompanhamento')]
class EtapaAcompanhamentoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_etapaAcompanhamento_';
    }
    ...
    {
        return "@ApplicationInternitEtapaAcompanhamento/etapaacompanhamento/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista EtapaAcompanhamento')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar EtapaAcompanhamento',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria EtapaAcompanhamento')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new EtapaAcompanhamento();
        $form = $this->createForm(EtapaAcompanhamentoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar EtapaAcompanhamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza EtapaAcompanhamento')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar EtapaAcompanhamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita EtapaAcompanhamento')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar EtapaAcompanhamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta EtapaAcompanhamento')]
