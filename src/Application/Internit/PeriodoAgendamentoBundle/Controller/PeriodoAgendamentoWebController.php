...
use App\Application\Internit\PeriodoAgendamentoBundle\Form\PeriodoAgendamentoType;
...
#[Route('/web/periodoAgendamento', name: 'web_periodoAgendamento_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'PeriodoAgendamento', description: 'Permissões do modulo PeriodoAgendamento')]
class PeriodoAgendamentoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_periodoAgendamento_';
    }
    ...
    {
        return "@ApplicationInternitPeriodoAgendamento/periodoagendamento/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista PeriodoAgendamento')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar PeriodoAgendamento',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria PeriodoAgendamento')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new PeriodoAgendamento();
        $form = $this->createForm(PeriodoAgendamentoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar PeriodoAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza PeriodoAgendamento')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar PeriodoAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita PeriodoAgendamento')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar PeriodoAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta PeriodoAgendamento')]
