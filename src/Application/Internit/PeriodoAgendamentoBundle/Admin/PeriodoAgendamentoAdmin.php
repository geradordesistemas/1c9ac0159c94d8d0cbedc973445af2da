<?php
namespace App\Application\Internit\PeriodoAgendamentoBundle\Admin;
...
final class PeriodoAgendamentoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof PeriodoAgendamento ? $object->getId().''
    ...
    protected function configureFormFields(FormMapper $form): void
    {
        $form->tab('Geral');
            $form->with('Informações Gerais');
                ...
                $form->add('periodo',  TextType::class, [
                    'label' => 'Periodo',
                    'required' =>  true ,
