...
use App\Application\Internit\DownloadBundle\Form\DownloadType;
...
#[Route('/web/download', name: 'web_download_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Download', description: 'Permissões do modulo Download')]
class DownloadWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_download_';
    }
    ...
    {
        return "@ApplicationInternitDownload/download/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Download')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar Download',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Download')]
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Download')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Download')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Download')]
