...
use App\Application\Internit\GaleriaEmpreendimentoBundle\Form\GaleriaEmpreendimentoType;
...
#[Route('/web/galeriaEmpreendimento', name: 'web_galeriaEmpreendimento_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'GaleriaEmpreendimento', description: 'Permissões do modulo GaleriaEmpreendimento')]
class GaleriaEmpreendimentoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_galeriaEmpreendimento_';
    }
    ...
    {
        return "@ApplicationInternitGaleriaEmpreendimento/galeriaempreendimento/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista GaleriaEmpreendimento')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar GaleriaEmpreendimento',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria GaleriaEmpreendimento')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new GaleriaEmpreendimento();
        $form = $this->createForm(GaleriaEmpreendimentoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar GaleriaEmpreendimento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza GaleriaEmpreendimento')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar GaleriaEmpreendimento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita GaleriaEmpreendimento')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar GaleriaEmpreendimento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta GaleriaEmpreendimento')]
