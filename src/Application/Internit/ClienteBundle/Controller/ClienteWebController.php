...
use App\Application\Internit\ClienteBundle\Form\ClienteType;
...
#[Route('/web/cliente', name: 'web_cliente_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Cliente', description: 'Permissões do modulo Cliente')]
class ClienteWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitCliente/cliente/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Cliente')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Cliente')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Cliente();
        $form = $this->createForm(ClienteType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Cliente')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Cliente')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Cliente')]
