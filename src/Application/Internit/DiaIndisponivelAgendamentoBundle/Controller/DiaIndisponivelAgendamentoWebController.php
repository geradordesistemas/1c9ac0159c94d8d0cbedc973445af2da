...
use App\Application\Internit\DiaIndisponivelAgendamentoBundle\Form\DiaIndisponivelAgendamentoType;
...
#[Route('/web/diaIndisponivelAgendamento', name: 'web_diaIndisponivelAgendamento_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'DiaIndisponivelAgendamento', description: 'Permissões do modulo DiaIndisponivelAgendamento')]
class DiaIndisponivelAgendamentoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_diaIndisponivelAgendamento_';
    }
    ...
    {
        return "@ApplicationInternitDiaIndisponivelAgendamento/diaindisponivelagendamento/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista DiaIndisponivelAgendamento')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar DiaIndisponivelAgendamento',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria DiaIndisponivelAgendamento')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new DiaIndisponivelAgendamento();
        $form = $this->createForm(DiaIndisponivelAgendamentoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar DiaIndisponivelAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza DiaIndisponivelAgendamento')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar DiaIndisponivelAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita DiaIndisponivelAgendamento')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar DiaIndisponivelAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta DiaIndisponivelAgendamento')]
