...
use App\Application\Internit\AgendamentoBundle\Form\AgendamentoType;
...
#[Route('/web/agendamento', name: 'web_agendamento_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Agendamento', description: 'Permissões do modulo Agendamento')]
class AgendamentoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_agendamento_';
    }
    ...
    {
        return "@ApplicationInternitAgendamento/agendamento/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Agendamento')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar Agendamento',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Agendamento')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $form = $this->createForm(AgendamentoType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Agendamento')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Agendamento')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Agendamento')]
