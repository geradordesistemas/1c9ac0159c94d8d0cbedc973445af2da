...
namespace App\Application\Internit\RespostaSolicitacaoBundle\Controller;
...
#[Route('/api/respostaSolicitacao', name: 'api_respostaSolicitacao_')]
#[OA\Tag(name: 'RespostaSolicitacao')]
#[ACL\Api(enable: true, title: 'RespostaSolicitacao', description: 'Permissões do modulo RespostaSolicitacao')]
class RespostaSolicitacaoApiController extends BaseApiController
{

    public function getClass(): string
    {
        return RespostaSolicitacao::class;
    }
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — RespostaSolicitacao.
     * Recupera a coleção de recursos — RespostaSolicitacao.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos RespostaSolicitacao',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar RespostaSolicitacao')]
    public function listAction(Request $request): Response
    {
        ...
        $filter = new FilterDoctrine(
            ...
            request: $request,
            attributesFilters: [
                'id', 'assunto', 'mensagem', 'andamentoSolicitacao', 'anexos', 
            ]
        );
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — RespostaSolicitacao.
     * Cria o Recurso — RespostaSolicitacao.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso RespostaSolicitacao',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'assunto', type: 'string'),
    ...
    public function createAction(Request $request): Response
    {
        ...
        $object = $this->objectTransformer->JsonToObject( $this->getClass(), $request , [
            'assunto', 'mensagem', 'andamentoSolicitacao', 'anexos', 
        ]);
    ...
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'RespostaSolicitacao não encontrado!'], 404);
    ...
    /** ****************************************************************************************** */
    /**
     * Substitui o recurso — RespostaSolicitacao.
     * Substitui o recurso — RespostaSolicitacao.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar RespostaSolicitacao')]
    ...
    /** ****************************************************************************************** */
    /**
    * Remove o recurso — RespostaSolicitacao.
    * Remove o recurso — RespostaSolicitacao.
    */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar RespostaSolicitacao')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'RespostaSolicitacao removido com sucesso.'], 204);
    }
