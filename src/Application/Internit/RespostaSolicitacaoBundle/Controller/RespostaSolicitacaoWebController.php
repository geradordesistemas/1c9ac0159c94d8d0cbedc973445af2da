...
use App\Application\Internit\RespostaSolicitacaoBundle\Form\RespostaSolicitacaoType;
...
#[Route('/web/respostaSolicitacao', name: 'web_respostaSolicitacao_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'RespostaSolicitacao', description: 'Permissões do modulo RespostaSolicitacao')]
class RespostaSolicitacaoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_respostaSolicitacao_';
    }
    ...
    {
        return "@ApplicationInternitRespostaSolicitacao/respostasolicitacao/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista RespostaSolicitacao')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar RespostaSolicitacao',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria RespostaSolicitacao')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new RespostaSolicitacao();
        $form = $this->createForm(RespostaSolicitacaoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar RespostaSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza RespostaSolicitacao')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar RespostaSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita RespostaSolicitacao')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar RespostaSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta RespostaSolicitacao')]
