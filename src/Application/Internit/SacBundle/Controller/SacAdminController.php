...
#[ACL\Admin(enable: true, title: 'Sac', description: 'Permissões modulo Sac')]
class SacAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Sac')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Sac')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Sac')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Sac')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Sac')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Sac em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Sac')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Sac')]
