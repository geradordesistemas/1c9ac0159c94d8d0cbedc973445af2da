...
use App\Application\Internit\SacBundle\Form\SacType;
...
#[Route('/web/sac', name: 'web_sac_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Sac', description: 'Permissões do modulo Sac')]
class SacWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitSac/sac/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Sac')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Sac')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Sac();
        $form = $this->createForm(SacType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Sac')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar Sac',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Sac')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Sac')]
