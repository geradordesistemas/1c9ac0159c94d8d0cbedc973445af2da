...
#[ACL\Admin(enable: true, title: 'DiaSemana', description: 'Permissões modulo DiaSemana')]
class DiaSemanaAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar DiaSemana')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar DiaSemana')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar DiaSemana')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar DiaSemana')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir DiaSemana')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir DiaSemana em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar DiaSemana')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar DiaSemana')]
