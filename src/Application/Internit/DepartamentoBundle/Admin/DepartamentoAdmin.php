<?php
namespace App\Application\Internit\DepartamentoBundle\Admin;
...
final class DepartamentoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof Departamento ? $object->getId().''
