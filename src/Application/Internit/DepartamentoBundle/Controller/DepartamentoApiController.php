...
#[Route('/api/departamento', name: 'api_departamento_')]
#[OA\Tag(name: 'Departamento')]
#[ACL\Api(enable: true, title: 'Departamento', description: 'Permissões do modulo Departamento')]
class DepartamentoApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — Departamento.
     * Recupera a coleção de recursos — Departamento.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos Departamento',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar Departamento')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — Departamento.
     * Cria o Recurso — Departamento.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso Departamento',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar Departamento')]
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera o recurso — Departamento.
     * Recupera o recurso — Departamento.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
        response: 200,
        description: 'Retorna recurso Departamento',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Departamento')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'Departamento não encontrado!'], 404);
    ...
    /** ****************************************************************************************** */
    /**
     * Substitui o recurso — Departamento.
     * Substitui o recurso — Departamento.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Departamento')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Departamento')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Departamento removido com sucesso.'], 204);
    }
