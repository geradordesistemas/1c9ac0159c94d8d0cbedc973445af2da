...
use App\Application\Internit\PeriodoDisponivelAgendamentoBundle\Form\PeriodoDisponivelAgendamentoType;
...
#[Route('/web/periodoDisponivelAgendamento', name: 'web_periodoDisponivelAgendamento_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'PeriodoDisponivelAgendamento', description: 'Permissões do modulo PeriodoDisponivelAgendamento')]
class PeriodoDisponivelAgendamentoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_periodoDisponivelAgendamento_';
    }
    ...
    {
        return "@ApplicationInternitPeriodoDisponivelAgendamento/periododisponivelagendamento/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista PeriodoDisponivelAgendamento')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar PeriodoDisponivelAgendamento',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria PeriodoDisponivelAgendamento')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new PeriodoDisponivelAgendamento();
        $form = $this->createForm(PeriodoDisponivelAgendamentoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar PeriodoDisponivelAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza PeriodoDisponivelAgendamento')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar PeriodoDisponivelAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita PeriodoDisponivelAgendamento')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar PeriodoDisponivelAgendamento',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta PeriodoDisponivelAgendamento')]
