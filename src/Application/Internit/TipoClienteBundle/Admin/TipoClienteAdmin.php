<?php
namespace App\Application\Internit\TipoClienteBundle\Admin;
...
final class TipoClienteAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof TipoCliente ? $object->getId().''
