<?php
namespace App\Application\Internit\EtapaBundle\Admin;
...
final class EtapaAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof Etapa ? $object->getId().''
