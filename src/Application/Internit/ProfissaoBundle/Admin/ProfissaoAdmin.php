<?php
namespace App\Application\Internit\ProfissaoBundle\Admin;
...
final class ProfissaoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof Profissao ? $object->getId().''
    ...
    protected function configureFormFields(FormMapper $form): void
    {
        $form->tab('Geral');
            $form->with('Informações Gerais');
                ...
                $form->add('profissao',  TextType::class, [
                    'label' => 'Profissao',
                    'required' =>  true ,
    ...
    protected function configureListFields(ListMapper $list): void
    {
        ...
        $list->addIdentifier('profissao', null, [
            'label' => 'Profissao',
