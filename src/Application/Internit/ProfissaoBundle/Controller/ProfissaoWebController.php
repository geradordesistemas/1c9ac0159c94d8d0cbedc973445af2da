...
use App\Application\Internit\ProfissaoBundle\Form\ProfissaoType;
...
#[Route('/web/profissao', name: 'web_profissao_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Profissao', description: 'Permissões do modulo Profissao')]
class ProfissaoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_profissao_';
    }
    ...
    {
        return "@ApplicationInternitProfissao/profissao/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Profissao')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Profissao')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Profissao();
        $form = $this->createForm(ProfissaoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar Profissao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Profissao')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar Profissao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Profissao')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar Profissao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Profissao')]
