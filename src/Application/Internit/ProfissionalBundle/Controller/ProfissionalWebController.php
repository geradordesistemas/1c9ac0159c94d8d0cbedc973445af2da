...
use App\Application\Internit\ProfissionalBundle\Form\ProfissionalType;
...
#[Route('/web/profissional', name: 'web_profissional_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Profissional', description: 'Permissões do modulo Profissional')]
class ProfissionalWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_profissional_';
    }
    ...
    {
        return "@ApplicationInternitProfissional/profissional/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Profissional')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar Profissional',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Profissional')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Profissional();
        $form = $this->createForm(ProfissionalType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Profissional')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Profissional')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Profissional')]
