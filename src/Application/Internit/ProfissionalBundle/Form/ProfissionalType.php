...
namespace App\Application\Internit\ProfissionalBundle\Form;
...
class ProfissionalType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('telefone1', TextType::class, [
            'label' => 'Telefone1',
            'required' =>  true ,
            'attr' => ['class' => ' form-control mb-2 '],
        ...
        $builder->add('telefone2', TextType::class, [
            'label' => 'Telefone2',
            'required' =>  false ,
            'attr' => ['class' => ' form-control mb-2 '],
        ...
        $builder->add('profissoes', EntityType::class, [
            'class' => Profissao::class,
            'choice_label' => function ($data) {
                return $data->getId() .' - '.$data->getProfissao();
            },
            'label' => 'Profissoes',
            'required' =>  false ,
            'multiple' =>  true ,
