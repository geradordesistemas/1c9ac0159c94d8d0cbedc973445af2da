...
use App\Application\Internit\EmpresaBundle\Form\EmpresaType;
...
class EmpresaWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitEmpresa/empresa/";
    }
    ...
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $filter = new FilterDoctrine(
            ...
            request: $request,
            attributesFilters: [
                'id', 'nome', 'email', 'telefone', 'cep', 'estado', 'cidade', 'bairro', 'rua', 'numero', 'complemento', 'logo', 
            ]
        );
    ...
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Empresa();
        $form = $this->createForm(EmpresaType::class, $data);
