...
#[ACL\Admin(enable: true, title: 'Comunicado', description: 'Permissões modulo Comunicado')]
class ComunicadoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Comunicado')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Comunicado')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Comunicado')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Comunicado')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Comunicado')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Comunicado em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Comunicado')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Comunicado')]
