...
use App\Application\Internit\AndamentoSolicitacaoBundle\Form\AndamentoSolicitacaoType;
...
#[Route('/web/andamentoSolicitacao', name: 'web_andamentoSolicitacao_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'AndamentoSolicitacao', description: 'Permissões do modulo AndamentoSolicitacao')]
class AndamentoSolicitacaoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_andamentoSolicitacao_';
    }
    ...
    {
        return "@ApplicationInternitAndamentoSolicitacao/andamentosolicitacao/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista AndamentoSolicitacao')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar AndamentoSolicitacao',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria AndamentoSolicitacao')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new AndamentoSolicitacao();
        $form = $this->createForm(AndamentoSolicitacaoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar AndamentoSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza AndamentoSolicitacao')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar AndamentoSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita AndamentoSolicitacao')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar AndamentoSolicitacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta AndamentoSolicitacao')]
