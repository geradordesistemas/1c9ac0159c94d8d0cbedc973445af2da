...
namespace App\Application\Internit\AndamentoSolicitacaoBundle\Controller;
...
#[Route('/api/andamentoSolicitacao', name: 'api_andamentoSolicitacao_')]
#[OA\Tag(name: 'AndamentoSolicitacao')]
#[ACL\Api(enable: true, title: 'AndamentoSolicitacao', description: 'Permissões do modulo AndamentoSolicitacao')]
class AndamentoSolicitacaoApiController extends BaseApiController
{

    public function getClass(): string
    {
        return AndamentoSolicitacao::class;
    }
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — AndamentoSolicitacao.
     * Recupera a coleção de recursos — AndamentoSolicitacao.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos AndamentoSolicitacao',
        content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(property: 'statusSolicitacao', type: 'integer' ),
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar AndamentoSolicitacao')]
    public function listAction(Request $request): Response
    {
        ...
        $filter = new FilterDoctrine(
            ...
            request: $request,
            attributesFilters: [
                'id', 'assunto', 'mensagem', 'visivel', 'statusSolicitacao', 'solicitacao', 
            ]
        );
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — AndamentoSolicitacao.
     * Cria o Recurso — AndamentoSolicitacao.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso AndamentoSolicitacao',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'assunto', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar AndamentoSolicitacao')]
    public function createAction(Request $request): Response
    {
        ...
        $object = $this->objectTransformer->JsonToObject( $this->getClass(), $request , [
            'assunto', 'mensagem', 'visivel', 'statusSolicitacao', 'solicitacao', 
        ]);
    ...
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'AndamentoSolicitacao não encontrado!'], 404);
    ...
    /** ****************************************************************************************** */
    /**
     * Substitui o recurso — AndamentoSolicitacao.
     * Substitui o recurso — AndamentoSolicitacao.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar AndamentoSolicitacao')]
    ...
    /** ****************************************************************************************** */
    /**
    * Remove o recurso — AndamentoSolicitacao.
    * Remove o recurso — AndamentoSolicitacao.
    */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar AndamentoSolicitacao')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'AndamentoSolicitacao removido com sucesso.'], 204);
    }
