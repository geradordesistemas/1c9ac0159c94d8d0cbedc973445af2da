...
#[Route('/api/solicitacao', name: 'api_solicitacao_')]
#[OA\Tag(name: 'Solicitacao')]
...
class SolicitacaoApiController extends BaseApiController
{
    ...
    public function createAction(Request $request): Response
    {
        ...
        $object = $this->objectTransformer->JsonToObject( $this->getClass(), $request , [
            'assunto', 'mensagem', 'data', 'tipoSolicitacao', 'periodoAgendamento', 'unidade', 'cliente', 'anexos', 
        ]);
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera o recurso — Solicitacao.
     * Recupera o recurso — Solicitacao.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
        response: 200,
        description: 'Retorna recurso Solicitacao',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'assunto', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Solicitacao')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'Solicitacao não encontrado!'], 404);
    ...
    /** ****************************************************************************************** */
    /**
     * Substitui o recurso — Solicitacao.
     * Substitui o recurso — Solicitacao.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Solicitacao')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Solicitacao')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Solicitacao removido com sucesso.'], 204);
    }
